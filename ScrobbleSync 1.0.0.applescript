...
set headers to "--user-agent \"ScrobbleChecker\" --referer \"https://stpc.carrd.co\" "
set baseURL to "\"http://ws.audioscrobbler.com/2.0/?method=track.getInfo"
set APIKey to "&api_key=9effc2d441f6ecb5dd8981066b2b3241"

set modeDialogResult to display dialog "Welcome to ScrobbleChecker. Which mode would you like to use?" buttons {"Fast Mode", "Overnight Mode"} default button "Fast Mode"
